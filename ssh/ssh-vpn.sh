...
REPO="https://raw.githubusercontent.com/kanggacorvpn/vipscripts/main/"
# initializing var
...
wget -O /etc/haproxy/haproxy.cfg "https://raw.githubusercontent.com/kanggacorvpn/vipscripts/ssh/main/haproxy.cfg"
