...
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e ""
    echo -e "\033[34m Contack WA/TLP: +62 877-4081-9772     \033[0m"
    echo -e "\033[34m Telegram user : t.me/kanggacorvpn \033[0m"    
    echo -e "\033[96m============================================\033[0m"
    exit 0
  fi
}
...
wget https://raw.githubusercontent.com/kanggacorvpn/vipscripts/main/domains.sh && chmod +x domains.sh && ./domains.sh
clear
}
...
TOOLS_PKG() {
cd
wget https://raw.githubusercontent.com/kanggacorvpn/vipscripts/main/PACKAGES/tools.sh && chmod +x tools.sh && ./tools.sh &> /dev/null
...
CHATID="74226275"
KEY="7382456251:AAFFC-8AotlfAQj6MXe4Mff-7MNX5yRs"
